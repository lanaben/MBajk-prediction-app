...
with dagshub_logger() as logger:
    for train_file, test_file in zip(train_files, test_files):
        ...
        with mlflow.start_run(run_name=run_name):
            ...
            mlflow.log_metrics({"train_mae": train_mae, "train_mse": train_mse, "train_r2": train_r2, "train_evs": train_evs,
                                "test_mae": test_mae, "test_mse": test_mse, "test_r2": test_r2, "test_evs": test_evs})

...
bike_data_dir = os.path.join(DATA_DIR, "raw", "bikes")
weather_data_dir = os.path.join(DATA_DIR, "raw", "weather")
...
def main():
    station_files = [f for f in os.listdir(bike_data_dir) if f.endswith('_raw_station_data.json')]
    for filename in station_files:
        file_path = os.path.join(bike_data_dir, filename)
